...
//     try {
//       const res = await axios.get("https://bmt-backend-1-vq3f.onrender.com/api/convenience-fees");
//       setFees(res.data);
//     } catch (err) {
...
//     try {
//       await axios.post("https://bmt-backend-1-vq3f.onrender.com/api/convenience-fees", formData);
//       fetchFees();
//       setShowForm(false);
//       setFormData({
...
function ConvenienceFee() {
  ...
  const fetchAirlines = async () => {
    try {
      const res = await axios.get("https://bmt-backend-1-vq3f.onrender.com/api/world-airlines");
  ...
  const handleSave = async () => {
    ...
    try {
      if (editId) {
        await axios.put(`https://bmt-backend-1-vq3f.onrender.com/api/convenience-fees/${editId}`, payload);
      } else {
        await axios.post("https://bmt-backend-1-vq3f.onrender.com/api/convenience-fees", payload);
      }
      resetForm();
      fetchFees();
    } catch (err) {
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this fee?")) {
      await axios.delete(`https://bmt-backend-1-vq3f.onrender.com/api/convenience-fees/${id}`);
      fetchFees();
    }
  };
