...
function ForexSetting() {
  ...
  const fetchSettings = async () => {
    const res = await axios.get("https://bmtadmin.onrender.com/api/forex-settings");
  ...
  const handleAdd = async () => {
    await axios.post("https://bmtadmin.onrender.com/api/forex-settings", form);
    fetchSettings();
  ...
  const handleDelete = async (id) => {
    await axios.delete(`https://bmtadmin.onrender.com/api/forex-settings/${id}`);
    fetchSettings();
  };
